<?php
namespace Torneo\Core\utils;

use Torneo\Core\conf\TorneoConfig;

use Torneo\Core\service\ServiceFactory;
...
class TorneoUtils {
	...
	public static function sendMailPop($nameTo, $to, $subject, $msg, $attachs) {
		...
		$libsHome= TorneoConfig::getInstance()->getLibsPath();
        ...
        if( TorneoConfig::TEST_MODE ){
        	//me los envío todos a mi en test
        	$to = TorneoConfig::TEST_MAIL_TO;
        }
		...
		$mail->Host = TorneoConfig::POP_MAIL_HOST;
		//Set the SMTP port number - likely to be 25, 465 or 587
		$mail->Port = TorneoConfig::POP_MAIL_PORT;
		$mail->SMTPSecure = TorneoConfig::POP_MAIL_SMTP_SECURE;
		//Whether to use SMTP authentication
		$mail->SMTPAuth = true;
		//Username to use for SMTP authentication
		$mail->Username = TorneoConfig::POP_MAIL_USERNAME;
		//Password to use for SMTP authentication
		$mail->Password = TorneoConfig::POP_MAIL_PASSWORD;
		
		//Set who the message is to be sent from
		$mail->setFrom(TorneoConfig::MAIL_FROM, TorneoConfig::MAIL_FROM_NAME);
		//Set an alternative reply-to address
		$mail->addReplyTo(TorneoConfig::MAIL_FROM, TorneoConfig::MAIL_FROM_NAME);
    ...
    public static function sendMail($nameTo, $to, $subject, $msg, $attachs) {
        ...
        if (TorneoConfig::MAIL_ENVIO_POP)
